Public Class skupina
    ...
    Private Sub SkupinaBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SkupinaBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.SkupinaBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.SkupinaDataSet)
