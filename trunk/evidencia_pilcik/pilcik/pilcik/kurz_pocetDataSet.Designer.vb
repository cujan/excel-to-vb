...
Partial Public Class kurz_pocetDataSet
    ...
    Partial Public Class kurzDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddkurzRow(ByVal nazov As String, ByVal zaciatok_kurzu As Date, ByVal koniec_kurzu As Date, ByVal typ As String, ByVal miesto_konania As String, ByVal pocet As Integer, ByVal cislo_protokolu As String) As kurzRow
            Dim rowkurzRow As kurzRow = CType(Me.NewRow,kurzRow)
            Dim columnValuesArray() As Object = New Object() {nazov, zaciatok_kurzu, koniec_kurzu, typ, miesto_konania, pocet, Nothing, cislo_protokolu}
    ...
    Partial Public Class kurzTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     COUNT(clenovia_kurzu.kurz_id) AS pocet, kurz.nazov, kurz.zaciatok_kurz"& _ 
                ...
                "      kurz.cislo_protokolu"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         kurz LEFT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                 "& _ 
                "     clenovia_kurzu ON clenovia_kurzu.kurz_id = kurz.id"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GROUP BY clenovia_kurzu"& _ 
                ".kurz_id, kurz.nazov, kurz.zaciatok_kurzu, kurz.koniec_kurzu, kurz.typ, kurz.mie"& _ 
                "sto_konania, kurz.id, kurz.cislo_protokolu"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
