...
Partial Public Class spz_evidenciaDataSet
    ...
    Partial Public Class clenoviaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddclenoviaRow(ByVal titul As String, ByVal meno As String, ByVal priezvisko As String, ByVal rodne_cislo As String) As clenoviaRow
...
Namespace spz_evidenciaDataSetTableAdapters
    ...
    Partial Public Class clenoviaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `clenovia` (`titul`, `meno`, `priezvisko`, `rodne_cislo`) VALUES (?, "& _ 
                "?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `clenovia` SET `titul` = ?, `meno` = ?, `priezvisko` = ?, `rodne_cislo` = "& _ 
                "? WHERE ((`ID` = ?) AND ((? = 1 AND `titul` IS NULL) OR (`titul` = ?)) AND ((? ="& _ 
                " 1 AND `meno` IS NULL) OR (`meno` = ?)) AND ((? = 1 AND `priezvisko` IS NULL) OR"& _ 
                " (`priezvisko` = ?)) AND ((? = 1 AND `rodne_cislo` IS NULL) OR (`rodne_cislo` = "& _ 
                "?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, titul, meno, priezvisko, rodne_cislo FROM clenovia"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_titul As String, ByVal Original_meno As String, ByVal Original_priezvisko As String, ByVal Original_rodne_cislo As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal titul As String, ByVal meno As String, ByVal priezvisko As String, ByVal rodne_cislo As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal titul As String, ByVal meno As String, ByVal priezvisko As String, ByVal rodne_cislo As String, ByVal Original_ID As Integer, ByVal Original_titul As String, ByVal Original_meno As String, ByVal Original_priezvisko As String, ByVal Original_rodne_cislo As String) As Integer
            If (titul Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_titul,String)
            End If
            If (Original_meno Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_rodne_cislo,String)
            End If
