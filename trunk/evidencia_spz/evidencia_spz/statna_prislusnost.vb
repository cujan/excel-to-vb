Public Class statna_prislusnost
    ...
    Private Sub Statna_prislusnostBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Statna_prislusnostBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Statna_prislusnostBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.Statna_prislusnostDataSet)
