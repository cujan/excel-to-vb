...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("narodeniny"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class narodeniny
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As narodeniny = CType(MyBase.Clone,narodeniny)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "narodeniny"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/narodeniny.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As narodeniny = New narodeniny
    ...
    Partial Public Class all_clenoviaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function Addall_clenoviaRow(ByVal meno As String, ByVal priezvisko As String, ByVal datum_narodenia As Date, ByVal okres_bydliska As String, ByVal psc As String, ByVal telefon As String, ByVal mesto As String, ByVal ulica As String, ByVal ulica_cislo As String, ByVal nazov As String) As all_clenoviaRow
            Dim rowall_clenoviaRow As all_clenoviaRow = CType(Me.NewRow,all_clenoviaRow)
            Dim columnValuesArray() As Object = New Object() {meno, priezvisko, datum_narodenia, okres_bydliska, psc, telefon, mesto, ulica, ulica_cislo, nazov}
...
Namespace narodeninyTableAdapters
    ...
    Partial Public Class all_clenoviaTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     all_clenovia.meno, all_clenovia.priezvisko, all_clenovia.datum_naroden"& _ 
                "ia, all_clenovia.okres_bydliska, all_clenovia.psc, all_clenovia.telefon, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                 all_clenovia.mesto, all_clenovia.ulica, all_clenovia.ulica_cisl"& _ 
                "o, zdruzenia.nazov"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         all_clenovia LEFT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                 "& _ 
                "     zdruzenia ON zdruzenia.ico = all_clenovia.clen_pz"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (DATEPART(mm, "& _ 
                "all_clenovia.datum_narodenia) LIKE @Param2) AND (zdruzenia.nazov LIKE @Param3)"
            ...
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@Param3", Global.System.Data.SqlDbType.NVarChar, 45, Global.System.Data.ParameterDirection.Input, true, 0, 0, "nazov", Global.System.Data.DataRowVersion.Current, Nothing))
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As narodeniny.all_clenoviaDataTable, ByVal Param2 As Decimal, ByVal Param3 As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(Param2,Decimal)
        ...
        Public Overloads Overridable Function GetData(ByVal Param2 As Decimal, ByVal Param3 As String) As narodeniny.all_clenoviaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(Param2,Decimal)
            If (Param3 Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(Param3,String)
            End If
            Dim dataTable As narodeniny.all_clenoviaDataTable = New narodeniny.all_clenoviaDataTable
    ...
    Partial Public Class TableAdapterManager
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As narodeniny, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateInsertedRows(ByVal dataSet As narodeniny, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateDeletedRows(ByVal dataSet As narodeniny, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overridable Function UpdateAll(ByVal dataSet As narodeniny) As Integer
